...
let UsersService = class UsersService {
    ...
    async getCurrentConnectedUser(userInfo) {
    ...
    async updateCurrentReservation(userId, reservationId) {
        const user = await this.UserModel.findOne({ _id: userId }).exec();
        return this.UserModel.updateOne({ _id: userId }, { UserCurrentReservationId: reservationId });
    }
    async updateAllReservations() {
        return await this.UserModel.updateMany({}, { $set: { UserCurrentReservationId: null } });
    }
};
