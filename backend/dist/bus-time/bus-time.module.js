...
exports.BusTimeModule = void 0;
const common_1 = require("@nestjs/common");
const bus_time_service_1 = require("./bus-time.service");
const bus_time_controller_1 = require("./bus-time.controller");
...
let BusTimeModule = class BusTimeModule {
};
exports.BusTimeModule = BusTimeModule;
exports.BusTimeModule = BusTimeModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([
                { name: busTime_schema_1.BusTime.name, schema: busTime_schema_1.BusTimeSchema, collection: 'bus-times' },
            ]),
            (0, common_1.forwardRef)(() => admin_module_1.AdminModule),
            (0, common_1.forwardRef)(() => bus_module_1.BusModule),
            (0, common_1.forwardRef)(() => BusTimeModule),
        ...
        controllers: [bus_time_controller_1.BusTimeController],
        providers: [bus_time_service_1.BusTimeService],
        exports: [bus_time_service_1.BusTimeService]
    })
], BusTimeModule);
//# sourceMappingURL=bus-time.module.js.map